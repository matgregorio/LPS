...
public class FrProfessor extends javax.swing.JFrame {
    ...
    public FrProfessor() {
        ...
        profController.atualizarTabela2(grdProfessor);
    }
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
     Professor professorEditando = (Professor) this.getObjectSelectOnGrid();

        if (professorEditando == null)
            JOptionPane.showMessageDialog(this, "Primeiro selecione um registro na tabela.");
        else {
            try {
                profController.excluirProfessor(professorEditando.getCpf());
