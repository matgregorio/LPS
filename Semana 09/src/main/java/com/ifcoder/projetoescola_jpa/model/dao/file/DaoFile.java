...
public abstract class DaoFile implements IDao{
    ...
    public void save(Object obj) {
        ...
        FileWriter arq = null;
        try {
            arq = new FileWriter(this.pathArquivo, true);
    ...
    protected List<Object> loadArquivo(Json object) {
        FileReader f = null;
        try {
            ...
            while (arquivoLido.hasNext()) {
                ...
                System.err.println(linhaLida);
                
                
                Object objetoLido = this.JSONToObjeto(object, linhaLida);                
     ...
     * @return 
     */
    private Object JSONToObjeto(Json obj, String linhaLidaCSV){        
        Object novo = obj.JSONToAtributo(linhaLidaCSV);
        return novo;
    }
